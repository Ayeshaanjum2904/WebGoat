...
var token = System.getenv("JWT_TOKEN_1");

Jwts.parser().setSigningKey(System.getenv("JWT_SIGNING_KEY_1")).parseClaimsJws(token);
----
...
[source]
----
var token = System.getenv("JWT_TOKEN_2");

Jwts.parser().setSigningKey(System.getenv("JWT_SIGNING_KEY_2")).parseClaimsJws(token);
----
...
[source]
----
var token = System.getenv("JWT_TOKEN_3");

Jwts.parser().setSigningKey(System.getenv("JWT_SIGNING_KEY_3")).parseClaimsJws(token);
----
